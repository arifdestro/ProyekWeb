...
?>
    ...
    <body>
        <center>
            <div id="card">
                ...
                <div id="c_left">
                    <img src="src/img/<?php echo $img; ?>" width="80px" height="100px" style="border:1px solid black;"><br>
                </div>
                <div id="c_right">
                    <table style="margin-top:23px;">
                        ...
                        <tr>
                            <td><b>Lomba yang diikuti</b></td>
                            <td>: <?php echo $lomba; ?></td>
                        </tr>
                    </table>
    ...
    <a href="cetak_kp.php"><button>Cetak</button></a>
    </center>
    </body>
